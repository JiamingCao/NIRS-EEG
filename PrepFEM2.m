...
[node, elem, face] = v2m(uint8(tmp.anatomy), iso_thresh, opt, 30, 'cgalmesh');
node = node(:, 1:3);
...
elem3(:, 5) = elem2(:, 5);
% Save in tet format
savetetgenele(elem3,'icbm152_09c/mesh_b2m.ele');
savetetgennode(node2,'icbm152_09c/mesh_b2m.node');
% save('icbm152_09c/pial', 'pial_n', 'pial_f');

% Load in fieldtrip
clear;
eegmesh = ft_read_headshape('icbm152_09c/mesh_b2m.ele', 'format', 'tetgen_ele');
...
% Save the headmodel
save('icbm152_09c/eegmodel', 'headmodel', '-v7.3')
clear

% Now load to NIRFAST (modified from auto generated code)
fprintf('Loading mesh to NIRFAST...\n')
solidmesh2nirfast('icbm152_09c/mesh_b2m.ele','/home/jiaming/Dropbox (CMU Biophotonics Lab)/CMU Biophotonics/Users/Jiaming/Research/Codes/Multi/icbm152_09c/nirs_mesh','stnd');
nirs_mesh = load_mesh('icbm152_09c/nirs_mesh');
% Place some optodes
...
save_mesh(nirs_mesh,'/home/jiaming/Dropbox (CMU Biophotonics Lab)/CMU Biophotonics/Users/Jiaming/Research/Codes/Multi/icbm152_09c/nirs_mesh');
clear nirs_mesh
nirs_mesh = load_mesh('/home/jiaming/Dropbox (CMU Biophotonics Lab)/CMU Biophotonics/Users/Jiaming/Research/Codes/Multi/icbm152_09c/nirs_mesh');   % Need to load again to move optodes to correct positions
...
% save
save('icbm152_09c/eegmodel', 'headmodel', 'lf', 'L', '-v7.3')
save('icbm152_09c/nirsmodel.mat', 'nirs_mesh', 'J_750', 'J_850', 'jacobian_nirs', 'jacobian_full', '-v7.3');
save('icbm152_09c/shared.mat', 'idx_dipole', 'brainmesh');
